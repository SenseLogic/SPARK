...
*   Copy the content of the **~/PROJECT/TOOL/SPARK/PROJECT** folder into a target folder of identical depth under the same root folder.<br>
    (ex: **~/PROJECT/SITE/TYRELL_CORPORATION/TYRELL_CORPORATION_SITE_2021**)
