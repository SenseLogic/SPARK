...
for %%f in (static\image\%1\*.*) do (
    ...
    %TOOL%\REMIX\remix %2 %TOOL%\IMAGE_MAGICK\convert "%%f" -resize 960x1920 -quality 55 -filter Lanczos -strip "..\www\static\image\%1\%%~nf.avif.wide.avif"
    %TOOL%\REMIX\remix %2 %TOOL%\IMAGE_MAGICK\convert "%%f" -resize 1280x2560 -quality 55 -filter Lanczos -strip "..\www\static\image\%1\%%~nf.avif.medium.avif"
