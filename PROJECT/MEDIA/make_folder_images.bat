...
for %%f in (static\image\%1\*.*) do (
    ...
    %TOOL%\REMIX\remix %2 %TOOL%\IMAGE_MAGICK\magick "%%f" -resize "1920x1920^>" -quality 70 -filter Lanczos -strip "..\www\static\image\%1\%%~nf.avif"
    %TOOL%\REMIX\remix %2 %TOOL%\IMAGE_MAGICK\magick "%%f" -resize "2560x2560^>" -quality 70 -filter Lanczos -strip "..\www\static\image\%1\%%~nf.avif.big.avif"
    %TOOL%\REMIX\remix %2 %TOOL%\IMAGE_MAGICK\magick "%%f" -resize "3840x3840^>" -quality 70 -filter Lanczos -strip "..\www\static\image\%1\%%~nf.avif.huge.avif"
)