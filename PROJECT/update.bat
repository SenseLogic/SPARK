...
copy %TOOL%\SPARK\PROJECT\CODE\ADMINISTRATION\CONTROLLER\make_backup_controller.phx CODE\ADMINISTRATION\CONTROLLER\
copy %TOOL%\SPARK\PROJECT\CODE\ADMINISTRATION\CONTROLLER\show_home_menu_controller.phx CODE\ADMINISTRATION\CONTROLLER\
copy %TOOL%\SPARK\PROJECT\CODE\ADMINISTRATION\CONTROLLER\update_sitemap_controller.phx CODE\ADMINISTRATION\CONTROLLER\
...
copy %TOOL%\SPARK\PROJECT\CODE\MODEL\connection_model.phx CODE\MODEL\
