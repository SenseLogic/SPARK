...
{
     $statement = GetDatabaseStatement( 'select `Id`, `PageSlug`, `BlockSlug`, `Slug`, `TypeSlug`, `Number`, `Title`, `Text`, `ImagePath`, `ImageVerticalPosition`, `ImageHorizontalPosition`, `VideoPath` from `CONTENT_BLOCK` order by `PageSlug` asc, `BlockSlug` asc, `Number` asc' );
...
{
     $statement = GetDatabaseStatement( 'select `Id`, `PageSlug`, `BlockSlug`, `Slug`, `TypeSlug`, `Number`, `Title`, `Text`, `ImagePath`, `ImageVerticalPosition`, `ImageHorizontalPosition`, `VideoPath` from `CONTENT_BLOCK`' );
...
{
     $statement = GetDatabaseStatement( 'select `Id`, `PageSlug`, `BlockSlug`, `Slug`, `TypeSlug`, `Number`, `Title`, `Text`, `ImagePath`, `ImageVerticalPosition`, `ImageHorizontalPosition`, `VideoPath` from `CONTENT_BLOCK` where `Id` = ? limit 1' );
...
{
     $statement = GetDatabaseStatement( 'insert into `CONTENT_BLOCK` ( `PageSlug`, `BlockSlug`, `Slug`, `TypeSlug`, `Number`, `Title`, `Text`, `ImagePath`, `ImageVerticalPosition`, `ImageHorizontalPosition`, `VideoPath` ) values ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )' );
...
{
     $statement = GetDatabaseStatement( 'replace into `CONTENT_BLOCK` ( `PageSlug`, `BlockSlug`, `Slug`, `TypeSlug`, `Number`, `Title`, `Text`, `ImagePath`, `ImageVerticalPosition`, `ImageHorizontalPosition`, `VideoPath` ) values ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )' );
    $statement->bindParam( 1, $page_slug, PDO::PARAM_STR );
    $statement->bindParam( 2, $block_slug, PDO::PARAM_STR );
    $statement->bindParam( 3, $slug, PDO::PARAM_STR );
    $statement->bindParam( 4, $type_slug, PDO::PARAM_STR );
...
{
     $statement = GetDatabaseStatement( 'update `CONTENT_BLOCK` set `PageSlug` = ?, `BlockSlug` = ?, `Slug` = ?, `TypeSlug` = ?, `Number` = ?, `Title` = ?, `Text` = ?, `ImagePath` = ?, `ImageVerticalPosition` = ?, `ImageHorizontalPosition` = ?, `VideoPath` = ? where Id = ?' );
    $statement->bindParam( 1, $page_slug, PDO::PARAM_STR );
    $statement->bindParam( 2, $block_slug, PDO::PARAM_STR );
    $statement->bindParam( 3, $slug, PDO::PARAM_STR );
    $statement->bindParam( 4, $type_slug, PDO::PARAM_STR );
