...
{
     $statement = GetDatabaseStatement( 'select `Id`, `PageId`, `TypeSlug`, `Number`, `LanguageCodeArray`, `Title`, `Text` from `TEXT_BLOCK` where `Id` = ? limit 1' );
...
{
     $statement = GetDatabaseStatement( 'insert into `TEXT_BLOCK` ( `Id`, `PageId`, `TypeSlug`, `Number`, `LanguageCodeArray`, `Title`, `Text` ) values ( ?, ?, ?, ?, ?, ?, ? )' );
    $statement->bindParam( 1, $id, PDO::PARAM_STR );
...
{
     $statement = GetDatabaseStatement( 'replace into `TEXT_BLOCK` ( `Id`, `PageId`, `TypeSlug`, `Number`, `LanguageCodeArray`, `Title`, `Text` ) values ( ?, ?, ?, ?, ?, ?, ? )' );
    $statement->bindParam( 1, $id, PDO::PARAM_STR );
    $statement->bindParam( 2, $page_id, PDO::PARAM_STR );
    $statement->bindParam( 3, $type_slug, PDO::PARAM_STR );
    $statement->bindParam( 4, $number, PDO::PARAM_STR );
...
{
     $statement = GetDatabaseStatement( 'update `TEXT_BLOCK` set `PageId` = ?, `TypeSlug` = ?, `Number` = ?, `LanguageCodeArray` = ?, `Title` = ?, `Text` = ? where Id = ?' );
