...
{
    return str_replace( [ HugeImageExtension, BigImageExtension, WideImageExtension, MediumImageExtension, SmallImageExtension, TinyImageExtension ], '', $image_path ) . PreloadImageExtension;
}
