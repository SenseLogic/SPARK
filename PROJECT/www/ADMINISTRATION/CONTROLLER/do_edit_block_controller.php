...
class DO_EDIT_BLOCK_CONTROLLER extends CONTROLLER
{
        ...
        )
    {
        ...
        SetDatabaseBlock( $block_id, $page_slug, $block_slug, $slug, $type_slug, $number, $title, $text, $image_path, $image_vertical_position, $image_horizontal_position, $video_path );
