...
class DO_EDIT_IMAGE_BLOCK_CONTROLLER extends CONTROLLER
{
        ...
        )
    {
        ...
        SetDatabaseImageBlock( $image_block_id, $page_id, $category_slug, $type_slug, $number, $language_code_array, $title, $text, $image_path, $image_vertical_position, $image_horizontal_position, $video_path );
