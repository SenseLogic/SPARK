...
class DO_ADD_PAGE_CONTROLLER extends CONTROLLER
{
        ...
        )
    {
        ...
        AddDatabasePage( $id, $route, $type_slug, $number, $language_code_array, $is_active, $title, $teaser, $image_path, $image_vertical_position, $image_horizontal_position, $video_path );
