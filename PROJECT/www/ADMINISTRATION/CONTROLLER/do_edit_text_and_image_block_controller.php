...
class DO_EDIT_TEXT_AND_IMAGE_BLOCK_CONTROLLER extends CONTROLLER
{
        ...
        )
    {
        ...
        SetDatabaseTextAndImageBlock( $text_and_image_block_id, $page_id, $block_id, $type_slug, $number, $language_code_array, $title, $text, $image_path, $image_vertical_position, $image_horizontal_position, $image_side, $video_path );
