...
class DO_EDIT_LEGAL_NOTICE_PAGE_CONTROLLER extends CONTROLLER
{
    // -- CONSTRUCTORS
        ...
        )
    {
        ...
        SetDatabaseLegalNoticePage( $legal_notice_page_id, $route, $type_slug, $number, $language_code_array, $is_active, $title, $text, $image_path, $image_vertical_position, $image_horizontal_position, $video_path );
...
// -- STATEMENTS
 ...
 $do_edit_legal_notice_page_controller = new DO_EDIT_LEGAL_NOTICE_PAGE_CONTROLLER(  $language_code,  $legal_notice_page_id );
