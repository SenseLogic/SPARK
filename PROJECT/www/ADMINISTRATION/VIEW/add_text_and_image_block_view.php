...
<script>
    ...
    function IsValidAddTextAndImageBlockForm()
    {
        var
            add_text_and_image_block_form,
        ...
        category_slug_field = add_text_and_image_block_form.CategorySlug;
        ...
        minimum_height_field = add_text_and_image_block_form.MinimumHeight;
        title_field = add_text_and_image_block_form.Title;
        text_field = add_text_and_image_block_form.Text;
        image_path_field = add_text_and_image_block_form.ImagePath;
        image_vertical_position_field = add_text_and_image_block_form.ImageVerticalPosition;
        image_horizontal_position_field = add_text_and_image_block_form.ImageHorizontalPosition;
        image_side_field = add_text_and_image_block_form.ImageSide;
        video_path_field = add_text_and_image_block_form.VideoPath;
        ...
        it_is_valid_add_text_and_image_block_form = true;
        ...
        return it_is_valid_add_text_and_image_block_form;
    }
</script>
<div id="add-text-and-image-block-view">
    <div class="page-section form-section">
        <form class="form-centered" name="AddTextAndImageBlockForm" onsubmit="return IsValidAddTextAndImageBlockForm()" action="/admin/text-and-image-block/add" method="post">
