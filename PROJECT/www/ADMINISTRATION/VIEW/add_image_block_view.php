...
<script>
    ...
    function IsValidAddImageBlockForm()
    {
        var
            add_image_block_form,
        ...
        minimum_height_field = add_image_block_form.MinimumHeight;
        ...
        video_path_field = add_image_block_form.VideoPath;
        ...
        it_is_valid_add_image_block_form = true;
        ...
        return it_is_valid_add_image_block_form;
    }
</script>
<div id="add-image-block-view">
    <div class="page-section form-section">
        <form class="form-centered" name="AddImageBlockForm" onsubmit="return IsValidAddImageBlockForm()" action="/admin/image-block/add" method="post">
