...
<script>
    ...
    function IsValidAddContentBlockForm()
    {
        ...
        image_vertical_position_field = add_content_block_form.ImageVerticalPosition;
        image_horizontal_position_field = add_content_block_form.ImageHorizontalPosition;
