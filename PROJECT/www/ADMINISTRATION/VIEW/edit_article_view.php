...
<script>
    ...
    function IsValidEditArticleForm()
    {
        ...
        importance_field = edit_article_form.Importance;
            ...
            <div class="form-container">
                ...
                <div>
                    <select class="form-select" name="Importance">
                        <option value="low" <?php if ( $this->Article->Importance === 'low' ) echo 'selected'; ?>>Low importance</option>
                        <option value="high" <?php if ( $this->Article->Importance === 'high' ) echo 'selected'; ?>>High importance</option>
                    </select>
                </div>
                <div class="form-field-name">
                    Next Article Id :
