...
<div id="view-block-view">
    <div class="page-section form-section">
        <div class="form-container">
            ...
            <div>
                <input-component result-class="form-input" result-name="Title" type_="text" result-value="<?php echo htmlspecialchars( GetValueText( $this->Block->Title ) ); ?>" result-readonly language-codes="<?php echo LanguageCodes; ?>" language-names="<?php echo LanguageNames; ?>"></input-component>
            </div>
            <div class="form-field-name">
                <?php echo htmlspecialchars( GetTextBySlug( 'Text' ) ); ?> :
            </div>
            <div>
                <textarea-component result-class="form-textarea" result-name="Text" result-readonly language-codes="<?php echo LanguageCodes; ?>" language-names="<?php echo LanguageNames; ?>"><?php echo htmlspecialchars( $this->Block->Text ); ?></textarea-component>
            </div>
            <div class="form-field-name">
