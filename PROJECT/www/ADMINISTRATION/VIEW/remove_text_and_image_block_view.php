...
<div id="remove-text-and-image-block-view">
    <div class="page-section form-section">
        <form class="form-centered" action="/admin/text-and-image-block/remove/<?php echo htmlspecialchars( $this->TextAndImageBlock->Id ); ?>" method="post">
            <div class="form-container">
                ...
                <div>
                    <input class="form-input" name="MinimumHeight" type="text" value="<?php echo htmlspecialchars( GetValueText( $this->TextAndImageBlock->MinimumHeight ) ); ?>" readonly/>
                </div>
                <div class="form-field-name">
