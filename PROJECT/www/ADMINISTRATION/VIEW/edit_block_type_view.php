    ...
    <div class="page-section form-section">
        <form class="form-centered" name="EditBlockTypeForm" onsubmit="return IsValidEditBlockTypeForm()" action="/admin/block-type/edit/<?php echo htmlspecialchars( $this->BlockType->Id ); ?>" method="post">
            <div class="form-container">
                ...
                <div>
                    <input-component result-class="form-input" result-name="Slug" type_="text" result-value="<?php echo htmlspecialchars( GetValueText( $this->BlockType->Slug ) ); ?>"></input-component>
                </div>
                <div class="form-field-name">
                    <?php echo htmlspecialchars( GetTextBySlug( 'Name' ) ); ?> :
                </div>
                <div>
                    <input-component result-class="form-input" result-name="Name" type_="text" result-value="<?php echo htmlspecialchars( GetValueText( $this->BlockType->Name ) ); ?>"></input-component>
                </div>
