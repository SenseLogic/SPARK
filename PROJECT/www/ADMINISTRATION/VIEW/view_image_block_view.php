...
<div id="view-image-block-view">
    <div class="page-section form-section">
        <div class="form-container">
            ...
            <div>
                    <input class="form-input" name="MinimumHeight" type="text" value="<?php echo htmlspecialchars( GetValueText( $this->ImageBlock->MinimumHeight ) ); ?>" readonly/>
            </div>
            <div class="form-field-name">
