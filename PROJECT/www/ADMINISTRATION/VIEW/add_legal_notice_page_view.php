...
<script>
    ...
    function IsValidAddLegalNoticePageForm()
    {
        var
            add_legal_notice_page_form,
            it_is_valid_add_legal_notice_page_form,
            id_field,
            route_field,
            type_slug_field,
            number_field,
        ...
        add_legal_notice_page_form = document.AddLegalNoticePageForm;
        id_field = add_legal_notice_page_form.Id;
        route_field = add_legal_notice_page_form.Route;
        type_slug_field = add_legal_notice_page_form.TypeSlug;
        number_field = add_legal_notice_page_form.Number;
        language_code_array_field = add_legal_notice_page_form.LanguageCodeArray;
        is_active_field = add_legal_notice_page_form.IsActive;
        title_field = add_legal_notice_page_form.Title;
        text_field = add_legal_notice_page_form.Text;
        image_path_field = add_legal_notice_page_form.ImagePath;
        image_vertical_position_field = add_legal_notice_page_form.ImageVerticalPosition;
        image_horizontal_position_field = add_legal_notice_page_form.ImageHorizontalPosition;
        video_path_field = add_legal_notice_page_form.VideoPath;
        ...
        it_is_valid_add_legal_notice_page_form = true;

        if ( id_field.value === "" )
        {
            id_field.AddClass( "form-field-error" );

            it_is_valid_add_legal_notice_page_form = false;
        }
        ...
        return it_is_valid_add_legal_notice_page_form;
    }
</script>
<div id="add-legal-notice-page-view">
    <div class="page-section form-section">
        <form class="form-centered" name="AddLegalNoticePageForm" onsubmit="return IsValidAddLegalNoticePageForm()" action="/admin/legal-notice-page/add" method="post">
