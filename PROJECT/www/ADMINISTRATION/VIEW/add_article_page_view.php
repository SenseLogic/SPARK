...
<script>
    ...
    function IsValidAddArticlePageForm()
    {
        var
        ...
        language_code_array_field = add_article_page_form.LanguageCodeArray;
        is_active_field = add_article_page_form.IsActive;
        title_field = add_article_page_form.Title;
        text_field = add_article_page_form.Text;
        image_path_field = add_article_page_form.ImagePath;
        image_vertical_position_field = add_article_page_form.ImageVerticalPosition;
        image_horizontal_position_field = add_article_page_form.ImageHorizontalPosition;
        ...
        it_is_valid_add_article_page_form = true;
        ...
        return it_is_valid_add_article_page_form;
    }
</script>
<div id="add-article-page-view">
    <div class="page-section form-section">
        <form class="form-centered" name="AddArticlePageForm" onsubmit="return IsValidAddArticlePageForm()" action="/admin/article-page/add" method="post">
