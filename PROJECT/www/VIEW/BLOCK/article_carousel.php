...
<div id="article-carousel" class="article-carousel">
    <div id="article-carousel-strip" class="article-carousel-strip">
        <?php for (  $article_page_index = 0; $article_page_index <= $article_page_count; ++$article_page_index ) { ?>
            ...
            <div class="article-carousel-slide" style="background: linear-gradient( rgba( 0, 0, 0, 0.1 ), rgba( 0, 0, 0, 0.1 ) ), url( '<?php echo $article_page->ImagePath; ?>?v=<?php echo VersionTimestamp; ?>' ) no-repeat <?php echo $article_page->ImageHorizontalPosition; ?> <?php echo $article_page->ImageVerticalPosition; ?> / cover, url( '<?php echo GetPreloadImagePath( $article_page->ImagePath ); ?>?v=<?php echo VersionTimestamp; ?>' ) no-repeat <?php echo $article_page->ImageHorizontalPosition; ?> <?php echo $article_page->ImageVerticalPosition; ?> / cover" onclick="ShowView( '<?php echo $article_page->Route; ?>' )">
