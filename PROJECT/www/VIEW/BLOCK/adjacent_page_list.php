...
<div class="adjacent-page-list">
    <div class="zoomed-button adjacent-page-list-button" style="background: url( '<?php echo  $prior_page->ImagePath; ?>' ) no-repeat center center / cover, url( '<?php echo $prior_page->ImagePath; ?>.preload.jpg' ) no-repeat center center / cover" onclick="ShowView( '<?php echo $prior_page->Route; ?>' )">
        <div class="adjacent-page-list-button-title">
            <?php echo $this->GetProcessedText( $prior_page->Title ); ?>
        </div>
    </div>
    <div class="zoomed-button adjacent-page-list-button" style="background: url( '<?php echo  $next_page->ImagePath; ?>' ) no-repeat center center / cover, url( '<?php echo $next_page->ImagePath; ?>.preload.jpg' ) no-repeat center center / cover" onclick="ShowView( '<?php echo $next_page->Route; ?>' )">
        <div class="adjacent-page-list-button-title">
