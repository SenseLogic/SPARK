...
<div id="<?php echo  $page->Slug; ?>" class="page">
    ...
    <div class="contact-page-heading" style="background: linear-gradient( rgba( 0, 0, 0, 0.1 ), rgba( 0, 0, 0, 0.1 ) ), url( '<?php echo $page->ImagePath; ?>' ) no-repeat center center / cover, url( '<?php echo GetPreloadImagePath( $page->ImagePath ); ?>' ) no-repeat center center / cover">
